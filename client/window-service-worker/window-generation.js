 ...
 *      Er moet een onderscheid gemaakt kunnen worden in wat apps kunnen - dit vertaald zich in een lijst met permissies in de metadata
 *      Een app moet een icoon kunnen hebben
 *      Een app moet een naam en beschrijving kunnen hebben
 */
...
class Window {
  ...
  createWindow() {
    const windowExists = this.windows.find(w => w.id === )
  }
